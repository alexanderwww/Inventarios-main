...
<!-- 
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="my-3">
                                                ...
                                                <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                                    ...
                                                    <input onkeyup="sobreinput(event);" style=" margin-left: -1px; border-radius:  5px 0 0  5px;" class="form-control validarDataView formDataView  stringClass trim" type="text" id="Entrada_View" disabled>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="my-3">
                                                ...
                                                <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                                    ...
                                                    <input onkeyup="sobreinput(event);" style=" margin-left: -1px; border-radius:  5px 0 0  5px;" class="form-control validarDataView borderRadiusInputPrice width100 formDataView  stringClass trim" type="text" id="Precio_View" disabled>
    ...
    <!-- ------------------------------------------------------------------------------------------------------------------------------------------------------  -->
        ...
        <div class="modal fade" tabindex="-1" id="btnAprobar" role="dialog" aria-hidden="true">
...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <p class="modal-title">¿Seguro que desea Aprobar la Orden de Compra?</p>

        </div>

        <div class="modal-footer">

            <button type="button" class="btn btn-danger btnModalAprobar" data-bs-dismiss="modal" id="Aprobar_compra">Aceptar</button>
