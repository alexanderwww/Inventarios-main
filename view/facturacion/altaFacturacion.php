...
<div class="container-xxl flex-grow-1 container-p-y">
    <input type="hidden" id="idPedido" value="<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>" />
    <input type="hidden" id="idPedidoEdit" value="<?php echo isset($_GET['idPedido']) ? $_GET['idPedido'] : ''; ?>" />
    <div class="row" style="gap:1rem">

        <div class="col-12">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light" id="titleAltaFacturacion">Alta Facturación /</span></h4>
        </div>
                ...
                <div class="m-3">
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label class="form-label">Quien Factura</label>
                                <div>
                                <select onchange="sobreSelectData(event)" class="form-control validarDataCliente getDataCliente" id="quienFactura" style="width:100%;"></select>
                                </div>
                                <p style="display:none; font-weight: bold; color: rgb(185, 74, 72)" id="ul_quienFactura" class="form_text_adv"></p>
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="gap:1rem">
                                ...
                                <div class="col">
                                    <div>
                                        <select class="form-control CFDIrelacionado" id="CFDIrelacionado" autocomplete="off" style="width:100%;"></select>
                                    </div>
                                </div>
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-end">
                ...
                <input type="button" class="btn btn-danger  text-white" id="regresarIndex" style="margin-left: 1rem;" value="Cancelar">
            </div>
