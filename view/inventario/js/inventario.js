...
const tablaPrincipal = () => {
    ...
    var tablaSSP = $('#tablaAjustes').DataTable({
        ...
        "order": [[0, "asc"]],
            ...
            $(api.column(1).footer()).html('Litros ' + pageTotalInventario.toFixed(2) + ' ( ' + formato(pageTotal) + ')');



            $(api.column(3).footer()).html('Litros ' + totalInventario.toFixed(2) + ' ( ' + formato(total) + ')');
