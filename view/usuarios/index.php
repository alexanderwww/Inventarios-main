...
<!-- NOTA CONTINUAR CON EL PROBLEMA DE CERRAR MODAL  -->
    ...
    <div class="card">
        ...
        <h5 class="card-header inline-head">
            ...
            <?php if ($_SESSION['Rol']['usuarioC'] == 1) : ?>
                ...
                <!-- <button id='btnNuevoUsuario' type="button" class="btn btn-primary derecha btnAltaCliente" data-toggle="modal" data-target="#altaUsuario">Usuario <i class='bx bxs-user-plus'></i></button> -->

                <button id='btnNuevoUsuario' type="button" class="btn btn-primary derecha btnAltaCliente" data-bs-toggle="modal" data-bs-target="#altaUsuario"><i class='bx bxs-user-plus'></i></button>
...
<div class="modal fade" id="altaUsuario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="altaUsuarioLabel" aria-hidden="true">

<!-- <div class="modal fade" id="altaUdsuario" tabindex="-1" role="dialog" aria-labelledby="altaUsuarioLabel" aria-hidden="true"> -->
<!-- <div class="modal fade" id="altaUsuario" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="altaUsuarioLabel" aria-hidden="true"> -->
