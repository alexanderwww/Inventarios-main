                            ...
                            <div id="smartwizard">
                                ...
                                <div class="tab-content" id='ziseContentForm'>
                                    ...
                                    <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
                                        ...
                                        <!-- -----------------------------CAMBIO ALEXANDER NOMBRE BANCO  -->
                                        <div class="field item form-group">

                                            <label class="col-form-label col-md-3 col-sm-3  label-align" for="nombreBancoProvedorAlta">Nombre de cuenta banco</label>

                                            <div class="col-md-6 col-sm-6">

                                                <input autocomplete="off" class="form_nombreBancoProvedorAlta form-control campoValidarCaracteresAlta formAltaProvedorDataInput trim" type="text" id="nombreBancoProvedorAlta" pattern="[A-Za-z0-9]{1,30}" placeholder="Nombre del banco">

                                                <p style="display:none; font-weight: bold; color: rgb(185, 74, 72)" id="ul_nombreBancoProvedorAlta" class="form_text_adv formNoReq_text_adv"></p>
                            ...
                            <div id="smartwizard2">
                                ...
                                <div class="tab-content" id='ziseContentForm2'>
                                    ...
                                    <div id="step-20" class="tab-pane" role="tabpanel" aria-labelledby="step-20">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align" for="banco">Nombre de cuenta banco</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input autocomplete="off" class="form_banco form-control  formEditarProvedorDataInput dataInputEditarProvedor campoValidarCaracteresEditar trim" type="text" id="banco" pattern="[A-Za-z0-9]{1,30}" placeholder="No Cuenta">
                                                <p style="display:none; font-weight: bold; color: rgb(185, 74, 72)" id="ul_banco" class="form_text_adv formNoReq_text_adv"></p>
                                            </div>
                                        </div>
