...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row" style="gap:1rem">
        ...
        <div class="col-12">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Alta Nota de Crédito /</span></h4>
        </div>
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input onkeyup="sobreinput(event);" class="form-control getDataCliente" id="fecha">
                                <p style="display:none; font-weight: bold; color: rgb(185, 74, 72)" id="ul_fecha" class="form_text_adv"></p>
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="gap:1rem">
                                ...
                                <div class="col">
                                    <div>
                                        <input type="text" class="form-control" id="CFDIrelacionado">
                                ...
                                <div class="col">
                                    ...
                                    <input type="button" class="btn btn-primary  text-white" id="insertCFDI" value="Nuevo Factura">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input onkeyup="sobreinput(event);" class="form-control" type="text" disabled id="totalesFacturas" value="0">
                                    <p style="display:none; font-weight: bold; color: rgb(185, 74, 72)" id="ul_totalesFacturas" class="form_text_adv"></p>
                                </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <h5 class="card-header inline-head">
                    ...
                    <input type="button" class="btn btn-primary  text-white" id="insertConcepto" value="Nuevo Partida">
                </h5>
                    ...
                    <table class="table" id="tablaPrincipal">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="minWidth">Folio cliente</th>
                ...
                <div class="m-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div>
                                <select class="form-select getDataBalanceConceptos" autocomplete="off" style="width:100%;" id="impuestosPorcentaje" >
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-end">
                <input type="button" class="btn btn-primary  text-white" id="insertFactura" value="Generar Nota de Crédito">
            </div>
