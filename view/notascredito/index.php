...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Notas de Crédito /</span> Lista de Notas de Crédito</h4>
    ...
    <div class="card">
        ...
        <h5 class="card-header inline-head">
            ...
            <?php if ($_SESSION['Rol']['odtC'] == 1) : ?>
                ...
                <a href="./alta.php" class="btn btn-primary derecha btnModalAlta">Nota de crédito <i class='bx bx-plus'></i></a>
