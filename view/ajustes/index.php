                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12  ">
                            ...
                            <form id="formAlta">
                                ...
                                <!-- <div class="form-group" style="display: flex; margin-left: -1px; ">
                                        <div class="col-md-3 col-sm-3" >
                                            <label class="col-form-label col-md-6 col-sm-6 label-align" for="PrecioActual_alta">PrecioActual</label>

                                            <input onkeyup="sobreinput(event);" style=" margin-left: -1px; border-radius:  5px 0 0  5px;" autocomplete="off" class="form-control formAltaData validarDataAlta stringClass trim" type="text" id="PrecioActual_alta" placeholder="">

                                            <p style="display:none; font-weight: bold; color: rgb(185, 74, 72)" id="ul_PrecioActual_alta" class="form_text_adv"></p>

                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <label class="col-form-label col-md-6 col-sm-6 label-align" for="Precio_alta">Precio </label>

                                            <input onkeyup="sobreinput(event);" style=" margin-left: -1px; border-radius:  5px 0 0  5px;" autocomplete="off" class="form-control formAltaData validarDataAlta stringClass trim mask-pesos" type="text" id="Precio_alta" placeholder="">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <label class="col-form-label col-md-3 col-sm-3  label-align" for="PrecioActual_alta">Precio Por Litro</label>
                                    ...
                                    <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                        ...
                                        <input onkeyup="sobreinput(event);" style=" margin-left: -1px; border-radius:  5px 0 0  5px;" autocomplete="off" class="form-control formAltaData  stringClass trim" type="text" id="PrecioActual_alta" placeholder="" disabled>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <label class="col-form-label col-md-3 col-sm-3  label-align" for="Precio_alta">Nuevo Precio</label>

                                    <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">

                                        <span class="input-group-text" style=" margin-left: -1px; border-top-right-radius: 0;border-bottom-right-radius: 0;">$</span>                        

                                        <input onkeyup="sobreinput(event);" style=" margin-left: -1px; border-radius:  5px 0 0  5px;" autocomplete="off" class="form-control formAltaData  stringClass trim mask-pesos" type="text" id="Precio_alta" placeholder="">
