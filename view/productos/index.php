                            ...
                            <form id="formAlta">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="divider divider-Dotted">
                                        <div class="divider-text"><span><strong>Reactivos de Seguridad</strong></span></div>
                                    </div>
                                ...
                                <div class="containerItems_alta" id="formItems_alta" style="display:none;">
                                    <div class="divider divider-Dotted">
                                        <div class="divider-text"><span><strong>Formulas</strong></span></div>
                                    </div>
                        ...
                        <div class="col-md-12 col-sm-12  ">
                            ...
                            <form id="formEdit">
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input onkeyup="sobreinput(event);" autocomplete="off" class="form-control formEditData validarCaracteresEdit stringClass trim validarDataEdit" type="number" id="Densidad" placeholder="">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input onkeyup="sobreinput(event);" autocomplete="off" class="form-control formEditData validarCaracteresEdit stringClass trim" type="number" id="Concentracion" placeholder="">
                                ...
                                <div class="row mb-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select onchange="sobreSelectData(event)" class=" form-control formEditData validarDataEdit " id='tipoUnidad'></select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="label-align" for="Flameabilidad">Flameabilidad </label>

                                            <!-- <input onkeyup="sobreinput(event);" autocomplete="off" class="form-control formAltaData validarCaracteresAlta stringClass trim" type="number" id="Flameabilidad_alta" placeholder=""> -->
                                            <select onchange="sobreSelectData(event)" type='select' class="form-control formEditData  stringClass trim" id="Flameabilidad" autocomplete="off">
                                                <option selected value="">Seleccione uno...</option>
                                                <option value="0">0 - No se inflama</option>
                                                <option value="1">1 - Sobre 93°C</option>
                                                <option value="2">2 - Debajo de 93°C</option>
                                        ...
                                        <div class="col-6">
                                            <label class="label-align" for="Reactividad">Reactividad </label>

                                            <select onchange="sobreSelectData(event)" type='select' class="form-control formEditData  stringClass trim" id="Reactividad" autocomplete="off">
                                                <option selected value="">Seleccione uno...</option>
                                                <option value="0">0 - Estable</option>
                                                <option value="1">1 - Inestable en caso de calentamiento</option>
                                                <option value="2">2 - Inestable en cambio de quimico violento</option>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="label-align" for="Toxicidad">Toxicidad </label>

                                            <select onchange="sobreSelectData(event)" type='select' class="form-control formEditData  stringClass trim" id="Toxicidad" autocomplete="off">
                                                <option selected value="">Seleccione uno...</option>
                                                <option value="0">0 - Minimo</option>
                                                <option value="1">1 - Ligero</option>
                                                <option value="2">2 - Moderado</option>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select onchange="sobreSelectData(event)" type='select' class="form-control formEditData  stringClass trim" id="Corrosividad" autocomplete="off">
                                                <option selected value="">Seleccione uno...</option>
                                                <option value="OX">Componentes oxidantes</option>
                                                <option value="ACID">Componentes ácidos</option>
                                                <option value="ALC">Se encuentran productos alcalinos</option>
                                ...
                                <div class="row mb-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input onkeyup="sobreinput(event);" autocomplete="off" class="form-control formEditData validarCaracteresEdit stringClass trim" type="text" id="CAS" placeholder="">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-4">
                        ...
                        <input onkeyup="sobreinput(event); statusPorcentaje(this.id)" autocomplete="off" class="form-control formDataExample Porcentaje_exampleClass stringClass trim" type="number" id="Porcentaje_example" placeholder="">
                    ...
                    <div class="col-7">
                        ...
                        <input onchange="sobreSelectData(event)" class=" form-control formDataExample formEditDataItems  ProductoPrimario_exampleClass2" id='ProductoPrimario_example2' style="display:none;" disabled></input>
