...
<!-- <div class="container-sm d-flex justify-content-center text-center m-2">



    <div class="card">

        <h4 class="fw-bold py-3 mb-4">Lista de Órdenes de Trabajo</h4>
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Orden de Trabajo /</span> Lista de Órdenes de Trabajo</h4>
    ...
    <div class="card">
        ...
        <h5 class="card-header inline-head">
            ...
            <input type="button" class="btn bg-success text-white" id="btnExcelOdt" nameTable='Órdenes de trabajo' style="outline: 0 !important;box-shadow: none !important;" name="<?php echo $_SESSION['Nombre']; ?>" value="Excel">

            <?php if ($_SESSION['Rol']['odtC'] == 1) : ?>

                <a href="./formulacion.php" class="btn btn-primary derecha btnModalAlta">Orden de trabajo <i class='bx bx-plus'></i></a>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h4 id="labelOdv">¿Desea Cerrar la orden de trabajo?</h4>
