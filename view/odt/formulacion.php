...
<div style="display: none;">
    ...
    <label class="label-align">Costo por Barril</label>
        ...
        <div class="col-12">
            <h5 class="titleVersionItem_Example"></h5>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                ...
                                <input class="form-control borderRadiusInputPercentaje totales_porcentaje" type="text" disabled>
                        ...
                        <td>
                            ...
                            <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                ...
                                <input class="form-control borderRadiusInputLiters totales_litrosBarril" type="text" disabled>
                        ...
                        <td>
                            ...
                            <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                ...
                                <input class="form-control borderRadiusInputLiters totales_litrosProducion" type="text" disabled>
                        ...
                        <td>
                            ...
                            <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                ...
                                <input class="form-control borderRadiusInputPrice totales_costoLitro" type="text" disabled>
                        ...
                        <td>
                            ...
                            <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                ...
                                <input class="form-control borderRadiusInputPrice totales_importe" type="text" disabled>
