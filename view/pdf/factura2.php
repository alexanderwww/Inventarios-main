...
function pdf($arrayData)
{
    ...
    // return;
    // CONTINAR DEBUGEANDO PDF 
    // $id_XML = $arrayData['folio'];
    $id_XML = 17103;

    $arrayData['xml'] = getDataXML($id_XML);

    $namePDF = $arrayData['xml']['uuid'];
    $htmlPDF = '<body>
    ...
    // $mpdf->Output('../Data/facturas/' . $namePDF . '.pdf', 'F');
