                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input onkeyup="sobreinput(event);" autocomplete="off" class="form-control formEditData validarCaracteresEdit stringClass trim" type="number" id="Densidad" placeholder="">
                                ...
                                <div class="row mb-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select onchange="sobreSelectData(event)" class=" form-control formEditData  " id='tipoUnidad'></select>
