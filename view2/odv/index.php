            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="row mb-3" style="align-items: center">
                    ...
                    <div class="my-3 col-lg-3 col-md-3 col-sm-3">
                        ...
                        <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            <input onkeyup="sobreinput(event); calcularTotal(event); " class="SubtotalEntrada borderRadiusInputLiters validarDataExample form-control formDataExample cantidadClass stringClass trim " type="text" id="cantidad_example">
                            <span class="input-group-text" style=" margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">LTS</span>
                        </div>
                    ...
                    <div class="my-3 col-lg-3 col-md-3 col-sm-4">
                        ...
                        <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            <span class="input-group-text" style=" margin-left: -1px; border-top-right-radius: 0;border-bottom-right-radius: 0;">$</span>
                            <input onkeyup="sobreinput(event);calcularTotal(event); " class="SubtotalEntrada borderRadiusInputPrice validarDataExample form-control formDataExample precioClass stringClass trim " type="text" pattern="[0-9,.]+" id="Precio_example" >
                        </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="row mb-3" style="align-items: center;">
                    ...
                    <div class="my-3 col-lg-3 col-md-3 col-sm-3">
                        ...
                        <div class="col-form-label col-md-6 col-sm-6" style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            <input onkeyup="sobreinput(event); calcularTotal(event);" class="SubtotalEntrada borderRadiusInputLiters validarDataExample  form-control formDataExample cantidadClass stringClass trim " type="text" id="cantidad_example" disabled>
                            <span class="input-group-text" style=" margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">LTS</span>
                        </div>
                    ...
                    <div class="my-3 col-lg-3 col-md-3 col-sm-4">
                        ...
                        <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            <span class="input-group-text" style=" margin-left: -1px; border-top-right-radius: 0;border-bottom-right-radius: 0;">$</span>
                            <input onkeyup="sobreinput(event);calcularTotal(event); " class="SubtotalEntrada borderRadiusInputPrice validarDataExample form-control formDataExample precioClass stringClass trim" type="text" id="Precio_example" disabled>
                        </div>
                    ...
                    <div class="my-3 col-lg-3 col-md-4 col-sm-6 ">
                        ...
                        <div style="display: flex; margin-left: -1px; border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            <span class="input-group-text" style=" margin-left: -1px; border-top-right-radius: 0;border-bottom-right-radius: 0;">$</span>
                            <input onkeyup="sobreinput(event);" class="form-control borderRadiusInputPrice  validarDataExample formDataExample Total totalClass    stringClass trim" type="number" id="Total_example" disabled>
                        </div>
